...
export function portrait(p,cls='') {
  ...
  return '<span class="framed-portrait '+cls+'" style="--portrait-scale:'+scale+'%;--portrait-x:'+x+'%;--portrait-y:'+y+'%"><span class="portrait-window"><img src="/Pirate%20Art/pirate_segments/zombie-pirate/zombie-pirate-'+p.id+'.png" alt="" draggable="false"></span>'+artImage('frame','portrait-frame')+'</span>';
}

...
function arena(){
 ...
 return `<section class="arena combat-arena polished-battle">
  ...
  <div class="turn-banner" id="turnBanner" role="status"><strong id="phaseLabel"></strong><span id="turnLabel"></span><span id="shots"></span><span id="turnClock"></span><span id="windIndicator"></span><span id="battleLog"></span></div>
